...
<div style="display:flex; flex-direction:column; gap:16px; max-width:860px;">
                ...
                <div style="flex:1;">
                    ...
                    <div style="font-size:12px; color:var(--text-muted);">
                        ...
                        @if($item->original_price > $item->price)
                            <span style="text-decoration:line-through; margin-left:4px;">৳{{ number_format($item->original_price, 0) }}</span>
                        @endif
                    </div>
                </div>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
        ...
        <div class="card" style="padding:20px;">
            ...
            <div style="display:flex; flex-direction:column; gap:10px; font-size:13px;">
                ...
                <div style="border-top:1px solid var(--border); padding-top:10px; display:flex; justify-content:space-between; font-weight:700; font-size:16px;">
                    <span>Total</span>
    ...
    <div class="card" style="padding:20px;">
        ...
        @if($order->notes)
        <div style="margin-top:12px; padding:10px; background:rgba(255,255,255,0.02); border-radius:8px; font-size:12px; color:var(--text-muted); border:1px solid var(--border);">
    ...
    <form method="POST" action="{{ route('buyer.orders.cancel', $order) }}"
        ...
        @csrf @method('PATCH')
        <button type="submit" style="width:100%; padding:12px; background:rgba(239,68,68,0.1); color:#fca5a5; border-radius:10px; font-size:13px; font-weight:600; border:1px solid rgba(239,68,68,0.2); cursor:pointer;">
